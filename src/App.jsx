...
//           <p>
//             Félicitations aux admis ! Que vous soyez de la session principale ou de la session de contrôle, importez votre capture d'écran du SMS Bac et obtenez votre score universitaire en quelques secondes.
//           </p>
        ...
        <div className="container">
          <div className={`calc-grid ${showResults ? "show-results" : ""}`} id="calcGrid">
            ...
            <div className="card">
              ...
              <div className="input-method upload-method">
                <h3>Importer une capture d'écran</h3>
                <p>Importez une capture d’écran de votre SMS Bac, qu’il s’agisse d’un résultat de la session principale ou de la session de contrôle .</p>
                <div className="upload-row">
                  <label htmlFor="capture"><i class="fa-solid fa-cloud-upload-alt"></i> Choisir une image</label>
                  <input type="file" id="capture" accept="image/*" onChange={handleImage} />
                  <span>{fileName !== "Aucun fichier" ? `📎 ${fileName}` : "PNG, JPG ou JPEG"}</span>
...
>
      ...
      <footer className="footer">
        <div className="container">
          <strong>Scorek fi 3 second</strong>  © 2026 · Calculateur non officiel du score Bac Tunisie · Créé par Maha Nouri · v1.1.1        </div>
      </footer>
    </div>
</>
    } />
