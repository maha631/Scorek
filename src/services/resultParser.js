...
//   // Détection robuste du mot ADMIS malgré les erreurs OCR
//   const admisRegex =
//     /(ADMIS|AOMIS|ADMI5|AOMI5|ADM1S|A0MIS)/;

//   const isAdmisByText =
//     admisRegex.test(normalized);
...
//   // Non admis seulement si :
//   // pas de mot ADMIS détecté ET moyenne < 10
...
//     moyenne,
//     controleText: normalized.substring(
//       controleIndex,
//       admisIndex !== -1
//         ? admisIndex
//         : normalized.length
